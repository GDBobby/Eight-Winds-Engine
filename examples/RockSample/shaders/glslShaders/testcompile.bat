...
C:\VulkanSDK\1.3.275.0\Bin\glslc.exe -x glsl -fshader-stage=mesh --target-spv=spv1.5 grass_NV_16.mesh -o ../grass.mesh.spv
C:\VulkanSDK\1.3.275.0\Bin\glslc.exe -x glsl -fshader-stage=mesh --target-spv=spv1.5 grass_NV_32.mesh -o ../grass.mesh.spv
