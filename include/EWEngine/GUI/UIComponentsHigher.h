...
namespace EWE {
	...
	public:
		...
		void ResizeWindow(lab::vec2 resizeRatio);
	...
	public:
		...
		TextStruct label;
		lab::Transform<float, 2> transform; //the background box
		lab::ivec4 dragBox; //height is about the size of the label string, width is the width of the full background box
